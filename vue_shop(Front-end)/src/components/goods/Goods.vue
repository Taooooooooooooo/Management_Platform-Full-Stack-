<template>
  <div>
    ...
    <el-card>
      <el-row>
        <el-col :span="8">
          <el-input v-model="qname" placeholder="请输入搜索名称" clearable @clear="getGoodsList">
            <el-button slot="append" icon="el-icon-search" @click="getGoodsList"></el-button>
          </el-input>
        </el-col>
        <el-col :span="4">
          <el-button type="primary" icon="el-icon-plus" @click="addGoodsPage">增加商品</el-button>
        </el-col>
      </el-row>
      <el-table :data="goodsList" border>
        ...
        <el-table-column label="商品库存" prop="number" width="80"></el-table-column>
